...
export default function ChapterNav({ chapterId }) {
  ...
  return (
    <nav
      aria-label="章節導航"
      className="flex items-center justify-center gap-4 sm:gap-6 py-6 border-t border-[--color-border] dark:border-[--color-dark-text-muted] font-[--font-sans-ui] text-sm flex-wrap"
    >
      {prev && (
